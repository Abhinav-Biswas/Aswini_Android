...
import static in.co.ecil.aswini_apk.MainActivity.MY_PREFS_NAME;
...
/*    String appName = "Aswini App";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            //Toast.makeText(UserActivity.this.getApplicationContext(), emailLink, Toast.LENGTH_SHORT).show();
            if (firebaseAuth.isSignInWithEmailLink(emailLink)) {
                // Retrieve this from wherever you stored it
                SharedPreferences prefs = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
                String restoredText = prefs.getString("emailID", null);
                if (restoredText == null) {
                    Toast.makeText(UserActivity.this.getApplicationContext(), "Please Enter your EC-Mail ID first.", Toast.LENGTH_LONG).show();
                    //Log.e(TAG, "Toast Error: " + restoredText);
                    startActivity(new Intent(UserActivity.this, MainActivity.class));
                }
                // The client SDK will parse the code from the link for you.
                else {
                    firebaseAuth.signInWithEmailLink(restoredText, emailLink)
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                @Override
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        //Log.d(TAG, "Successfully signed in with email link!");
                                        Toast.makeText(UserActivity.this.getApplicationContext(), "Successfully Logged in with EC-Mail link!", Toast.LENGTH_LONG).show();
                                        ...
                                        Toast.makeText(UserActivity.this.getApplicationContext(), "Invalid Link... \nPlease Login again. ", Toast.LENGTH_LONG).show();
                                        startActivity(new Intent(UserActivity.this, MainActivity.class));
    ...
    private void setUserDisplayView() {

        setContentView(R.layout.activity_user);
        navigationView = findViewById(R.id.nav_view);
        myLinearLayout = findViewById(R.id.user_content);
        ...
        webview.setDownloadListener(new DownloadListener()
        {
            ...
            public void onDownloadStart(String url, String userAgent,
                ...
                request.setDestinationInExternalFilesDir(UserActivity.this,
    ...
    public  class myWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            } else if (url.contains("gstn.ecil.co.in")) {
                //getSupportActionBar().setTitle("Payroll Login");
                view.getSettings().setUseWideViewPort(false);
            ...
            if (url.contains("http://aswini.ecil.co.in/quicklinks")) {
                ...
                //Toast.makeText(UserActivity.this, "Loading... \nPlease Wait!", Toast.LENGTH_LONG).show();
                view.loadUrl("javascript:" +
                        "(function() {" +
                        //"document.getElementsByTagName('body')[0].style.backgroundImage = 'none';" +
                        "document.getElementsByTagName('form')[0].style.width = 'none';" +
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if (url.contains("payslips.ecil.co.in/session_login")){
                Toast.makeText(UserActivity.this, "Loading... \nPlease Wait!", Toast.LENGTH_LONG).show();
            }
        }
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            ...
            alertDialog.setMessage("Check your Internet connection is enabled or else the Server may be down. \nPlease contact the Administrator");
...
/*        if (item.getItemId() == R.id.action_settings) {
    ...
    private void displayAboutView() {
        webview.loadDataWithBaseURL("file:///android_res/drawable/", MainActivity.html, "text/html", "utf-8", null);
    }
